  ...
  return (
    <nav className='flex-div'>
      <div className="nav-left flex-div">
         ...
         <Link to='/'> <img className='logo' src='https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/Logo_of_YouTube_%282015-2017%29.svg/1024px-Logo_of_YouTube_%282015-2017%29.svg.png' alt="" /></Link>
      </div>
